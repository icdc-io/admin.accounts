...
const destroyInfrastructureAction = (payload) => ({
  ...
  payload: deleteData(
    `/api/setup/${API_VERSION}/${ActionTypes.setupAccountUrl(payload.accountId)}`,
  ),
});
...
const setupAccountAction = (setupBody) => ({
  ...
  payload: createData(
    `/api/setup/${API_VERSION}/${ActionTypes.setupAccountUrl(setupBody.accountName)}`,
    setupBody.quotas,
  ),
});
...
const createAccountAction = (payload) => ({
  ...
  payload: createData(
    `/api/accounts/${API_VERSION}/${ActionTypes.ACCOUNTS_REGISTRATION_URL}`,
    payload,
  ),
});
